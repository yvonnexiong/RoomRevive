...
{
    // InputSplatData is defined in GaussianSplatting.Runtime (Runtime/GaussianSplatting/InputSplatData.cs)
    // and is accessible here via the 'using GaussianSplatting.Runtime;' directive above.
