Shader "XRCC/Yinan Sprite Sphere Intersection URP"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            Name "Yinan Sprite Sphere Intersection"
            ...
            half4 Frag(Varyings input) : SV_Target
            {
                ...
                half4 spriteColor = spriteSample * input.color;
                ...
                float alpha = band * noiseMask * _EffectColor.a * _Intensity * spriteColor.a;
                alpha = saturate(alpha);

                float energy = band * (1.0 + scan + fresnel);

                float3 color = _EffectColor.rgb * energy * _Intensity;
                color *= spriteColor.rgb;
